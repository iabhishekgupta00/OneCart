...
export const allOrders = async (req,res) => {
    try {
        ...
        console.log(error)
        return res.status(500).json({message : "alladminOrders Error"})
...
export const placeOrderRazorpay = async (req,res) => {
    try {
        ...
        console.log(error)
        res.status(500).json({ message: error.message || "Razorpay order error" });
    }
}
...
export const verifyRazorpay = async (req,res) => {
    try {
        ...
        console.log(error)
        res.status(500).json({ message: error.message || "Razorpay req order error" });
