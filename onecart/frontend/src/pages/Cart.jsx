        ...
        <div className="w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative">
            ...
            <div className="flex items-start justify-center flex-col gap-[10px]">
                ...
                <input
                    ...
                    className="w-[60px] py-[5px] px-[10px]
                     text-white text-[18px] font-semibold 
                     bg-[#518080b4] border-[1px] border-[#9ff9f9] 
                     rounded-md mt-2"
                ...
                />
                <IoTrashBinSharp className="text-[#9ff9f9] w-[25px]
                h-[25px] absolute top-[50%] md:top-[40%]
                md:right-[5%] right-1" 
             ...
             <div className='flex justify-start items-end my-20'>
                <div className='w-full sm:w-[450px]'>
                    ...
                    cursor-pointer bg-[#51808048] py-[10px]
                    px-[50px] rounded-2xl flex text-white items-center
                    justify-center gap-[20px] border-[1px]
